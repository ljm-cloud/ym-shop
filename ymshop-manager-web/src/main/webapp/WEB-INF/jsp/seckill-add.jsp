...
<div class="page-container">
    ...
    <form name="seckill-add" action="" method="post" class="form form-horizontal" id="seckill-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">分割库存：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <div id="parentSwitch" class="switch" data-on-label="是" data-on="info" data-off-label="否">
                    <input type="checkbox" checked="checked" id="split" name="split" />
                </div>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss'})" id="startDate" name="startDate" class="input-text Wdate" style="width:220px;">
                </div>
        </div>
        <div class="row cl">
