...
CREATE TABLE `tb_order` (
  ...
  `order_site` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '订单站点   main:主站订单   rushbuy:抢购订单',
  `prom_id` varchar(20) COLLATE utf8_bin DEFAULT NULL COMMENT '秒杀活动id',
...
CREATE TABLE `tb_seckill` (
  ...
  `seckill_desc` varchar(255)  DEFAULT NULL,
