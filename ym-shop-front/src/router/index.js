...
const rushBuyGoods = () => import('/page/Goods/rushBuyGoods.vue')
const rushBuyDetails = () => import('/page/Goods/rushBuyDetails.vue')
...
const checkoutRushBuy = () => import('/page/Checkout/checkoutRushBuy.vue')
  ...
  routes: [
    {
      ...
      children: [
        ...
        {path: 'rushBuyGoods', name: 'rushBuyGoods', component: rushBuyGoods},
        {path: 'rushBuyDetails', name: 'rushBuyDetails', component: rushBuyDetails},
    ...
    {path: '/checkoutRushBuy', name: 'checkoutRushBuy', component: checkoutRushBuy},
    {path: '*', redirect: '/home'}
  ]
})
