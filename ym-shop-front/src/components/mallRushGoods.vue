<template>
  <div class="good-item">
    <div style="">
      <div class="good-img">
        <a @click="openProduct(msg.promId)">
          <img v-lazy="msg.productImageBig" :alt="msg.productName" :key="msg.productImageBig">
        </a>
        <div class="good-img-child" @click="openProduct(msg.promId)">
          <img src="/static/images/sellout.png" v-if="msg.state==='sellout'"/>
          <img src="/static/images/nobegin.png" v-if="msg.state==='nobegin'"/>
          <img src="/static/images/promend.png" v-if="msg.state==='end'"/></div>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goodsDetails (id) {
        this.$router.push({path: 'rushBuyDetails/promId=' + id})
      },
      openProduct (id) {
        window.open('//' + window.location.host + '/#/rushBuyDetails?promId=' + id)
      },
