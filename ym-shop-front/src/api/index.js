...
// 强化型验证码
export const getStrongCaptcha = (params) => {
  return http.fetchGet('/member/getStrongCaptcha', params)
}
// 秒杀排队接口
export const secKill = (params) => {
  return http.fetchPost('/member/secKill', params)
}
// 秒杀资格查询
export const querySecKillResult = (params) => {
  return http.fetchGet('/member/querySecKillResult', params)
}
// 添加秒杀购物车
export const addSecKillCart = (params) => {
  return http.fetchPost('/member/addSecKillCart', params)
}
