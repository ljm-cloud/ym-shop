...
// 支付
export const alipayQrCode = (params) => {
  return http.fetchGet('/member/alipayQrcode', params)
}
// 获取用户订单
...
// 抢购商品查询
export const getRushBuyGoods = (params) => {
  return http.fetchGet('/goods/rushBuyGoods', params)
}
// 抢购商品查询
export const getRushBuyDetails = (params) => {
  return http.fetchGet('/goods/rushBuyDetails', params)
}
