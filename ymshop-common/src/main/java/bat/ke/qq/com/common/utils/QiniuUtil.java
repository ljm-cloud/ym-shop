...
public class  QiniuUtil {
     ...
     * 生成上传凭证，然后准备上传
     */
    private static String accessKey = "d7jmSy5QhAQrSt2_ptG87cSQc88X7EkfSH4KapDn";
    private static String secretKey = "EO-5568thcUmMwBzyrbHOTx9IifmbxwQVtGMNxzT";
    private static String bucket = "ym-shop";
    private static String origin="http://q5ui1hvjh.bkt.clouddn.com/";
...
//        {"error":"incorrect region, please use up-z0.qiniup.com"}
        //构造一个带指定Zone对象的配置类 zone2华南   根据自己的存储空间指定
